			...
			<div class="content-area-block">
				...
				<font color="red" style="font-family: open-sans-condensed, sans-serif; font-size: 22px">${message}</font>
					<form:form id="login-form" action="login" modelAttribute="loginBean">
						<span><label class="input-group-addon" for="username"><i class="fa fa-user"></i></label></span>
						<span><input  type="text" id="loginField" name="username" class="text-input" placeholder="Логин">	</span>							
						<span><label class="input-group-addon" for="password"><i class="fa fa-lock"></i></label> </span>
						<span><input type="password" id="passField" name="password" class="text-input" placeholder="Пароль"></span>
